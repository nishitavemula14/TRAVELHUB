    ...
    <AuthPageLayout>
        <section className="mx-auto w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
         ...
         <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <p className="mt-4 text-center text-sm text-slate-500">Already have an account?{" "}
              <Link className="font-semibold text-blue-600 hover:text-blue-700" to="/login" state={location.state}>Login</Link>
          </p>
        </section>
    </AuthPageLayout>
);
